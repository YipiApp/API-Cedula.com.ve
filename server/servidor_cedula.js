/**
* Api de Consultas de Cedulas Venezolanas - Servidor API
*
...
function selectOne(query, args, conn, cb) {
    try{
        //console.log("selectOne: "+query+" "+JSON.stringify(args));
...
function proccessV1(query, req, res) {
...
https.createServer(options, function (req, res) {
    ...
    if(parsedUrl.pathname == '/api/v1')
        return proccessV1(parsedUrl.query, req, res);

    return respondError(res, 'URL_ERROR');
}).listen(444);