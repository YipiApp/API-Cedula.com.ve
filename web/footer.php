<?php 
/**
* Api de Consultas de Cedulas Venezolanas - Footer
*
...
<div class="footer">
    <div class="container">
        <div class="col-md-8">
            <h3 style="color:white">Consulta de Cédulas</h3>
            <ul class="list1">
                <li><a href="index.php">API</a></li>
                <li><a href="precios.php">Precios</a></li>
                <li><a href="login.php">Mi Cuenta</a></li>
                <li><a href="http://wiki.cedula.com.ve/" target="_blank">Documentación del API</a></li>
        ...
        <div class="col-md-4">
            ...
            <div class="col-md-12" style="text-align:center;color:white">&copy;2015 Desarrollado por <a href="https://cuado.co/" target="_blank" style="color:white">Cuado</a></div>
        </div>
    </div>
</div>
<script>
